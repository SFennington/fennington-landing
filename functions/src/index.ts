...
// Financial categorization is deployed as its own function (see financialApiApp
// below) so it can ship independently of the Stripe secrets the main api
// function requires for checkout/webhook routes.
