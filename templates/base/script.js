...
const CONFIG = {
  businessName: "Fennington [BUSINESS NAME]",  // e.g., "Fennington Snow Removal"
  nicheName: "[NICHE]",                         // e.g., "Snow Removal", "Electrical"
  city: "Denver",
  phone: "(720) 555-0123",
  email: "info@fennington[niche].com",          // e.g., "info@fenningtonsnowremoval.com"
  address: "1234 Main Street, Denver, CO 80202",
  hours: "Mon-Fri: 8:00 AM - 5:00 PM<br>Sat: By Appointment<br>Sun: Closed",
  
  // Hero section text
  heroHeadline: "Professional [NICHE] Services",
  heroSubtitle: "Expert [niche] serving Denver since 2012. Licensed, insured, and backed by 200+ five-star reviews.",
